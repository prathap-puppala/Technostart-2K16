...
$qu=mysql_query("SELECT * from notifications WHERE nid='$sno' && visibility='1'");
if(mysql_num_rows($qu)>=1)
{
mysql_query("UPDATE notifications SET views=views+1 WHERE nid='$sno'");
...
<title><?php echo $title;?> | Show Notice</title>
   ...
   <!--CONTENT START-->
    <div id="content">
    	<div class="contentbg">
			...
			<tr><td><?php echo $d['title'];?></td></tr>
			<tr>
				<th>Description</th>
			</tr>
			<tr><td><?php echo $d['description']."<br>".$d['attachments'];?></td></tr>	
			
			<tr>
				<th>Views</th>
			</tr>
			<tr><td><?php echo $d['views'];?></td></tr>	
			
			<tr>
				<th>Notice To</th>
			</tr>
			<tr><td><?php $nto=$d['views'];if($nto!="ALL"){$ddd=mysql_fetch_array(mysql_query("SELECT * FROM events WHERE eid='$nto'"));$nto=$ddd['branch']." - ".$ddd['eventname'];}echo $nto;?></td></tr>	
			<tr>
				<th>Time</th>
			</tr>
			<tr><td><?php echo $d['time'];?></td></tr>																				
		</table>
