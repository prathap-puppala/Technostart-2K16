...
if($isregopen=="on")
{
if(isset($_POST['stuid']) && isset($_POST['mobnum']) && isset($_POST['seckey']) && isset($_POST['passwd']) && isset($_POST['cpasswd']) && isset($_POST['captcha']))
{
...
{
$passwd=md5($passwd);
mysql_query("UPDATE users SET passwd='$passwd' WHERE stuid='$stuid'");
echo "<script>alert('Recovered Successfully');</script>";
}	
else
{
...
{
document.getElementById("msg").innerHTML="Confirm Password and Password are not same";
return false;
}
        		...
        		<div class="contentbottom">
                    ...
                    <form method="post" action="<?php htmlentities($_SERVER['PHP_SELF']);?>" id="inquiry2" name="business" style="padding-left:7px;" language="JavaScript" onSubmit="return checkform();">
                      ...
                      <p>
                        ...
                        <input type="password" tabindex="4"  value="" id="passwd" name="passwd" />
                      </p>
                      <p>
                        <label for="cpasswd">Re-type Password:<span>*</span></label>
                        <input type="password" tabindex="4"  value="" id="cpasswd" name="cpasswd" />
                      </p>
                      <p>
