    	...
    	<div class="contentbg">
        	<div class="contenttop">
        		<div class="contentbottom">
        			<h1>About TECHNOSTART'16</h1>
                    <p><font style="color:#0080C0;font-family:Adobe Gothic Std;font-weight:bold;font-size:20px;text-align:left;">TECHNOSTART</font>
                    
					is a mega event for the Computer Science discipline and provides an elagant platform for the enthusiastic participants.It is amalgamation of both the technical and non-technical events which invokes creativity and fun.Technostart promises you a blissful journey.
