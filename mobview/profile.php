    	...
    	<div class="contentbg">
        	<div class="contenttop">
        		<div class="contentbottom">
        			<h1><small>Welcome</small> <?php echo $det['stuname'];?></h1> <br><br>
                  <center>
                  <a href="editprofile" title="Edit Profile" class="button3">Edit Profile</a><br><br><br>
				  <a href="changepass" title="Change Password" class="button1">Change Password</a><br><br><br>
				  <a href="adminmsgs" title="Admin Messages" class="button4">Admin Messages</a><br><br><br>
				  <a href="regdonetoeve" title="Registered Events" class="button7">Registered Events</a>
                  <br>
                  <br>
                  <br>
                  <br>
