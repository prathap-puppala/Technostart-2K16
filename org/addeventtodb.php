...
if(!in_array($extension,$allowed))
  ...
  mysql_query("INSERT INTO isyearrestrictions(eid,eventname,branch,P1,P2,E1,E2,E3,E4) VALUES('$curid','$eventname','$branch','$resarP1','$resarP2','$resarE1','$resarE2','$resarE3','$resarE4')");
		}
		echo "<script>alert('Event successfully added');window.location='index.php';</script>";
	}
	else
	{
