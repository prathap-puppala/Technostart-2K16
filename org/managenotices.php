...
if(branch=="")
    ...
    <div class="box-out">
    	<div class="box-in">
    		<div class="box-head"><h1>Edit Notices</h1></div>
...
?>
	  	<div class="notification error">
    				<div class="messages">Sorry!!!  Webteam Stopped Editing Notices...Please Contact webteam<div class="close"><img src="img/icon/close.png" alt="close" /></div></div>
    			</div>
...
else
{
  ...
  while($branch_cat=mysql_fetch_array($settings)){
			  $sno++; echo "<tr><td class='id".$sno."'><div class='even'>".$branch_cat['title']."</div></td><td class='id".$sno."'><div class='even'>".$branch_cat['description']."</div></td><td class='id".$sno."'><div class='even'>".$branch_cat['attachments']."</div></td><td class='id".$sno."'><div class='even'>".$branch_cat['views']."</div></td><td class='id".$sno."'><div class='even'><a class='tooltip' title='Edit ".$branch_cat['title']."' style='cursor:pointer;' onclick='managenoticedetails(".$branch_cat['nid'].",".$sno.")'>Edit Notice</a></div></td></tr>"; 
		   }
