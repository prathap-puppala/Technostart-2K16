...
?>
 <link rel="stylesheet" type="text/css" href="css/loginform.css" />
			...
			<section class="main" id="Regg">
				<form class="form-2" action="javascript:void(0);" onsubmit="doforgot()" method="post">
					<h1><span class="log-in">FORGOT PASSWORD</span></h1><img src="img/closelabel.gif" style="float:right;margin-top:-30px;cursor:pointer;" onclick="prathap_hide_popup_boxes()">
			...
			<tr><td>
				...
				<tr><td colspan="2" style="text-align:center;">
					...
					<tr><td colspan="2"><hr><a style="cursor:pointer;color:green;font-size:13px;" onclick="shwfrm('register')">Register</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a style="cursor:pointer;color:green;float:right;font-size:13px;" onclick="shwfrm('login')">Login</a></td></tr>
					...
					<tr><td colspan="2"><hr><center>For Password Recovery Problems Contact <b>Prathap (9010932254)</b></center></td></tr>
					</table>
				</form>​​
			</section>
