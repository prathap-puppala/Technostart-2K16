...
if($isregopen=="on")
{
$que=mysql_query("SELECT * FROM partoorgmsg WHERE eid='$eid' ORDER BY sno DESC");
while($q=mysql_fetch_array($que))
{
$col="green";
$sender=$stuid;
if($q['sender']==$stuid){$col="blue";}
if($q['sender']!=$stuid){$sender="Organizer";}
echo "<p style='color:".$col.";font-weight:bold;'>".$sender." : <span style='color:black;font-weight:normal;'>".$q['subject']."</span></p>";
}
}
else
{
