...
?>
 <link rel="stylesheet" type="text/css" href="css/loginform.css" />
			...
			<section class="main" id="Regg">
				<form class="form-2" action="javascript:void(0);" onsubmit="doreg(<?php echo $fee;?>)" method="post">
					<h1><span class="log-in">Register</span></h1><img src="img/closelabel.gif" style="float:right;margin-top:-30px;cursor:pointer;" onclick="prathap_hide_popup_boxes()">
...
<td style="padding-left:30px;padding-right:20px;">
						...
						<input type="text" name="mobnum" id="mobnum" placeholder="">
			</td>
</tr>
			<tr>
			</tr>
			 <tr><td>
					...
					<td style="padding-left:30px;padding-right:20px;">
						<label for="cpasswd"><i class="icon-user"></i>Re-type Password</label>
						<input type="password" name="cpasswd" id="cpasswd" placeholder="ex: *****">
			</td></tr>
			 <tr>
					<td>
						<label for="seckey"><i class="icon-user"></i>Security Key</label>
						<input type="password" name="seckey" id="seckey" placeholder="ex: *****">
			</td><td style="padding-left:30px;padding-right:20px;">
						<label for="cseckey"><i class="icon-user"></i>Re-enter Sec Key</label>
						<input type="password" name="cseckey" id="cseckey" placeholder="ex: *****">
			</td></tr>
			...
			<tr><td>
				...
				<tr><td colspan="2" style="text-align:center;">
						...
						<input type="submit" name="submit" value="Register" style="float:right;"></center>
					</td></tr>
					<tr><td colspan="2"><hr><a style="cursor:pointer;color:red;font-size:13px;" onclick="shwfrm('forgot')">Forgot Password?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a style="cursor:pointer;color:green;float:right;font-size:13px;" onclick="shwfrm('login')">Login</a></td></tr>
